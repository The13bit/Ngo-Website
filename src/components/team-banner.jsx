...
import './Styles/team-banner.css'

const TeamBanner = (props) => {
  return (
    <div className={`team-banner-container ${props.rootClassName} `}>
      <div className="team-banner-container1">
        <img
          alt={props.imageAlt}
          src={props.imageSrc}
